<!DOCTYPE html>
<html>
	<?php if (isset($_SESSION['verifyotplog'])) { echo "<script>alert('" . $_SESSION['verifyotplog'] . "');</script>"; $this->session->unset_userdata('verifyotplog'); } ?>
<head>
	<meta charset="utf-8">
			...
			<!--content-->
				<section class="content center full-width">
					<div class="modal container">
						...
						<h3>A One-Time Pin (OTP) has been sent to your email (<?php echo explode("[][]",$_SESSION['registerdata_mx'])[4]; ?>). Please check your mailbox and enter your OTP below.</h3>
						<div class="f-row">
