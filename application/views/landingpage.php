		...
		<div class="wrap clearfix">
			...
			<div class="row">
					...
					<div class="cwrap">
						...
						<div class="entries row">
							...
							<div class="featured two-third">
								...
								<article class="entry">
									<figure>
										<img style="max-width: 100%; max-height: 100%; width: 100%" src="<?php echo site_url("static/images") . "/" . $randrecipe[0]['recipeImg']; ?>" alt="" />
				...
				<aside class="sidebar one-fourth">
					...
					<div class="widget">
						<h3>Our android app is out now! Download it <a href="/mealsformakers.apk" target="_BLANK">here</a>!</h3>
						<a href="/mealsformakers.apk" target="_BLANK">
							<img src="images/appscreenshot.png" />
						</a>
					</div>
				</aside>
			</div>
