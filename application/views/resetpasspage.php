<!DOCTYPE html>
<html>
	<?php if (isset($_SESSION['resetpasslog'])) { echo "<script>alert('" . $_SESSION['resetpasslog'] . "');</script>"; $this->session->unset_userdata('resetpasslog'); } ?>
<head>
	<meta charset="utf-8">
			...
			<!--content-->
				<section class="content center full-width">
					<div class="modal container">
						...
						<h3>A One-Time Pin (OTP) has been sent to your email. Please check your mailbox and enter your OTP below, together with your new password.</h3>
						<div class="f-row">
							<input type="text" name="userotp" placeholder="Input OTP here..." required/>
						</div>
						<div class="f-row">
							<input type="password" name="userpassnorm" placeholder="Input your new password here..." required/>
						</div>
						<div class="f-row">
							<input type="password" name="userpasstwo" placeholder="Repeat your new password here..." required/>
						</div>
