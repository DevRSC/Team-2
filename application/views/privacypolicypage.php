			...
			<div class="wrap clearfix">
				...
				<div class="row">
					<article class="policy-text">
						...
						<p>Meals for Makers recognizes our role and social obligation in safeguarding any personal information in our possession.
                            As a result, we have developed this privacy policy to expressly state our intention to comply with all applicable laws 
                            and regulations regarding personal information usage and disclosure, to implement an appropriate data protection 
                            management system, and to maintain and improve such system in light of the social and technological changes of an 
                            ever-changing society. <br><br>
                            Meals for Makers has created this Privacy Policy to inform you of our policies and procedures for collecting, using, 
                            and disclosing personal information collected from users of the Meals for Makers. This Privacy Policy may be updated 
                            from time to time. Any substantial changes will be notified to you by publishing the revised Privacy Policy on the site. 
                            It is recommended that you review this policy on a frequent basis for any modifications. Unless otherwise stated, terms 
                            used in this Privacy Policy have the same meanings as in our Terms of Service.
                        </p>
                        <h2>Data Collected by Us</h2>
						<p>Our primary goals in collecting information are to deliver and enhance our services, as well as to allow users to enjoy 
                            and use the application conveniently. <br>
                            We may collect the following personal data from you:
                            
                            <ul>
                                <li>Personal details</li>
                                <li>Authentication data</li>
                                <li>Profile information, if you setup an account with us.</li>
                                <li>Information you voluntarily provide about yourself, such as food preferences.</li>
