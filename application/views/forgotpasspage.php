<!DOCTYPE html>
<html>
<?php if (isset($_SESSION['forgotpasslog'])) { echo "<script>alert('" . $_SESSION['forgotpasslog'] . "');</script>"; $this->session->unset_userdata('forgotpasslog'); $_POST = array();} ?>
<head>
	<meta charset="utf-8">
				...
				<section class="content center full-width">
					<form action="Forgotpass" method="POST">
						<div class="modal container">
							...
							<p>Remembered your password now? <a href="login">Login.</a></p>
						</div>
					</form>
				</section>
				<!--//content-->
